      ...
      <div className="persona-card" style={{ padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            <span className="persona-starburst" style={{ width: 60, height: 60 }}>
              <span>TAKE<br />YOUR<br />TIME</span>
            </span>
            <h2 className="persona-glitch" style={{ fontSize: '20px', fontFamily: "'Impact', sans-serif", letterSpacing: '0.15em', margin: 0, color: '#00e5ff', textShadow: '-2px 2px 0px #e60012' }}>
    ...
    <div className="controls-header nerv-frame" style={{ position: 'relative', borderBottom: 'none', padding: '16px', background: '#000000', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
          ...
          <h2 style={{ fontSize: '18px', fontFamily: 'var(--font-heading)', letterSpacing: '0.15em', margin: 0, color: '#ffffff', textShadow: '0 0 10px rgba(255, 153, 0, 0.6)' }}>
      ...
      <button 
        ...
        style={{
          ...
          letterSpacing: '0.1em', cursor: 'pointer', border: '1px solid #ff9900',
